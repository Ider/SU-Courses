...
The password for the Administrator account in this application is "password123!" (without the quotes).


MVC Music Store tutorial for ASP.NET MVC 2 - v1.0 release
